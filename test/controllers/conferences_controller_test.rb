...
class ConferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conference" do
    assert_difference('Conference.count') do
      post conferences_url, params: { conference: { end_time: @conference.end_time, start_time: @conference.start_time, wicys: @conference.wicys } }
    end
  ...
  test "should update conference" do
    patch conference_url(@conference), params: { conference: { end_time: @conference.end_time, start_time: @conference.start_time, wicys: @conference.wicys } }
