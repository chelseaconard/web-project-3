...
class RecommendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommend" do
    assert_difference('Recommend.count') do
      post recommends_url, params: { recommend: { idea: @recommend.idea, topic: @recommend.topic } }
    end
  ...
  test "should update recommend" do
    patch recommend_url(@recommend), params: { recommend: { idea: @recommend.idea, topic: @recommend.topic } }
